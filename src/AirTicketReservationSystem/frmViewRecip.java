...
public class frmViewRecip extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnDeleteRecip = new javax.swing.JButton();
        ...
        txtSearchRecip = new javax.swing.JTextField();
        jLabel16 = new javax.swing.JLabel();
        combSearchType = new javax.swing.JComboBox<>();
        btnSearch = new javax.swing.JButton();

        setClosable(true);
        setTitle("View Reciption");
        ...
        btnDeleteRecip.setIcon(new javax.swing.ImageIcon(getClass().getResource("/AirTicketReservationSystem/IconRemoveUser24x.png"))); // NOI18N
        btnDeleteRecip.setText("Delete");
        btnDeleteRecip.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDeleteRecipActionPerformed(evt);
            }
        });
        ...
        combSearchType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Reciption ID", "Username" }));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtSearchRecip, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(combSearchType, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel16)
                        .addComponent(btnSearch)
                        .addComponent(txtSearchRecip)))
                .addContainerGap())
        );
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        MDIForm.frmViewRecipActive = true;
        ...
        this.btnUpdateRecip.setEnabled(false);
        this.btnDeleteRecip.setEnabled(false);
        ...
        this.lblReciptionDetails.setEnabled(false);
        ...
        this.lblRecipId.setEnabled(false);
        this.lblReciptionID.setEnabled(false);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        MDIForm.frmViewRecipActive = false;
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if(this.txtSearchRecip.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Empty Search Field","Search Error",JOptionPane.ERROR_MESSAGE);            
        }
        else{
            if(this.combSearchType.getSelectedItem().toString().equals("Reciption ID")){
                boolean found=false;
                try{
                    String SQL = "select userID from logininfo where accessType='recip' and userID='"+this.txtSearchRecip.getText()+"'";
                    Statement stmnt = dbcon.createStatement();
                    ResultSet rs = stmnt.executeQuery(SQL);
                    while(rs.next()){
                        if(rs.getString("userID").equals(this.txtSearchRecip.getText())){
                            found=true;
                        }
                    }
                }
                ...
                if(found){
                    ...
                    getRecipDetails_RecipID(this.txtSearchRecip.getText());
                    this.btnSaveRecip.setEnabled(false);
                    this.btnUpdateRecip.setEnabled(true);
                    this.btnDeleteRecip.setEnabled(true);
                    this.btnAddImage.setEnabled(false);
                    this.btnRemoveImage.setEnabled(false);
                    ...
                    this.lblReciptionDetails.setEnabled(true);
                    ...
                    this.lblRecipId.setEnabled(true);
                    this.lblReciptionID.setEnabled(true);
                ...
                String userId="";
                try{
                    String SQL = "select userID,userName from logininfo where userName='"+this.txtSearchRecip.getText()+"'";
                    Statement stmnt = dbcon.createStatement();
                    ResultSet rs = stmnt.executeQuery(SQL);
                    while(rs.next()){
                        if(rs.getString("userName").equals(this.txtSearchRecip.getText())){
                ...
                if(found){
                    JOptionPane.showMessageDialog(null, "Match found","Search Success",JOptionPane.INFORMATION_MESSAGE);
                    getRecipDetails_RecipID(userId);
                    this.btnSaveRecip.setEnabled(false);
                    this.btnUpdateRecip.setEnabled(true);
                    this.btnDeleteRecip.setEnabled(true);
                    this.btnAddImage.setEnabled(false);
    ...
    private void btnDeleteRecipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteRecipActionPerformed
        ...
        if(userChoice==0){
            String SQL = "delete from userinfo where userID='"+this.lblRecipId.getText()+"'";
            String SQL2 = "delete from logininfo where userID='"+this.lblRecipId.getText()+"'";
            try{
                Statement stmnt = dbcon.createStatement();
                Statement stmnt2 = dbcon.createStatement();
                stmnt.executeUpdate(SQL);
                stmnt2.executeUpdate(SQL2);
                JOptionPane.showMessageDialog(null, "Account "+this.lblRecipId.getText()+" deleted successfully", "Delete Successful!", JOptionPane.INFORMATION_MESSAGE);
                //-----------------
                    this.setClosed(true);
    ...
    }//GEN-LAST:event_btnDeleteRecipActionPerformed
...
//                }
    ...
    private javax.swing.JButton btnDeleteRecip;
    ...
    private javax.swing.JTextField txtSearchRecip;
